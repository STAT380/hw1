...
matrix(c(r1, r2), nrow = 2, ncol = 100, byrow=TRUE)
...
I would expect row_wise_time to take shorter to run due to the fact that numbers are easer read left to right.
...
I can conclude that on average, row_wise_time takes longer to perform.
