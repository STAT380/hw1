...
I expect col_wise_scan to be shorter because the function is iterating through a single vector rather than switching vectors every time.
...
I can conclude that a column wise scan is going to be faster than a row wise scan.
